...
export async function find_most_powerful_hover_engine(
    ship: Ship,
): Promise<HoverEngine | undefined> {
    let best: HoverEngine | undefined;
    let best_thrust = -Infinity;
    for (const engine of ship.get_all(ModuleType.HOVER_ENGINE)) {
