...
enum class Cooldown {
  ...
  eDefault           =  10000 +  2 * 11,
  eRCS               =  25000 +  3 * 11,
  eHoverEngine       =  25000 +  5 * 11,
  ePassiveScanner    =  50000 +  7 * 11,
  eMessanger         =  50000 + 11 * 11,
  eAsteroidMiner     = 150000 + 13 * 11,
  eAsteroidScanner   = 150000 + 17 * 11,
  eShipyard          = 150000 + 23 * 11,
  eResourceContainer = 200000 + 29 * 11,
  eBlueprintsStorage = 200000 + 31 * 11,
  eGame              = 200000 + 37 * 11,
};
#else
