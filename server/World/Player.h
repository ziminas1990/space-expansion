...
public:
  ...
  // Creates an additional session to root commutator and returns it's id.
  // The connection, specified by 'nConnectionId' should be opened already (see
  // onNewConnection())
  uint32_t createAdditionalSession(uint32_t nConnectionId);
